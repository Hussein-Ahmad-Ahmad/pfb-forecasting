...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='PatchFusionBERT publication package')

    # basic config
    parser.add_argument('--task_name', type=str, required=True, default='long_term_forecast',
                        help='task name, publication package supports: [long_term_forecast]')
    ...
    if args.task_name != 'long_term_forecast':
        raise ValueError('This publication package only supports task_name=long_term_forecast')
