...
try {
    ...
    $components = @(
        [pscustomobject]@{ Name = 'PatchOnly'; Model = 'PatchFusionBERT_PatchOnly'; ExtraArgs = @() },
        [pscustomobject]@{ Name = 'RefineOnly'; Model = 'PatchFusionBERT_RefineOnly'; ExtraArgs = @('--pfb_k', [string]$RefinementDepth) },
        [pscustomobject]@{ Name = 'FusionOnly'; Model = 'PatchFusionBERT_v0'; ExtraArgs = @('--pfb_k', '0') },
        [pscustomobject]@{ Name = 'Full'; Model = 'PatchFusionBERT_v0'; ExtraArgs = @('--pfb_k', [string]$RefinementDepth) }
    )
