...
OUT_CSV_V2 = OUT_DIR / "pfbv2_kdepth_ablation.csv"
OUT_TEX = OUT_DIR / "pfbv0_kdepth_ablation.tex"
OUT_TEX_V2 = OUT_DIR / "pfbv2_kdepth_ablation.tex"
...
def main() -> None:
    ...
    for tag, out_csv, out_tex, label in [
        ("KDepth_MS",   OUT_CSV,    OUT_TEX,    "v0"),
        ("KDepthV2_MS", OUT_CSV_V2, OUT_TEX_V2, "v2"),
    ]:
