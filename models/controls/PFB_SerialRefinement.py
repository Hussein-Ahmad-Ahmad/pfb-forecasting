"""
PFB-SerialRefinement: serial-refinement component control.

Chain interpretation:
- PFB-PatchOnly: backbone only
- PFB-SerialRefinement: backbone plus serial refinement without fusion
- pfb_k=0: backbone plus fusion without extra serial depth
- pfb_k>0: backbone plus fusion with extra serial depth
"""
